...
const firstAndLastname = inventors.map((names) => {
...
//   { first: 'Katherine', last: 'Blodgett', year: 1898, passed: 1979 }
// ]
const yearOfBirth = inventors.sort((birthyearA, birthyearB) => {
...
// { first: 'Ada', last: 'Lovelace', year: 1815, passed: 1852 }
// ]
const lengthOfLife = inventors.sort((a, b) => {
  const yearsLivedOne = a.passed - a.year
  const yearsLivedTwo = b.passed - b.year
  return yearsLivedTwo - yearsLivedOne
})
console.log(lengthOfLife)
...
const specificPerson = inventors.find((name) => {
  return name.last === "Edison"
})
